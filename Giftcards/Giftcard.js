  ...
  function Giftcard() {
    ...
    return (
      <div className='giftitems'>
        <div className="giftbanner"><img src="https://assets-in.bmscdn.com/promotions/cms/creatives/1692874595339_fdf.jpg" style={{width:"100%"}} alt="" /> 
        <div className="btn"><button>E-GIFT CARDS</button>
        <button>PHYSICAL GIFT CARDS</button></div>
        </div>
      ...
      <div className="f-row">
        {
         ...
         return(
        <div className="itemcard"> <img src={giftcard.gift} alt="" /></div>
         )
         })
         }
      </div> 
